...
st.header("Italy Constitution AI Assistant")
st.markdown("#### I am an AI assistant, here to help you understand, learn and query on Italy's Constitution!")
with st.sidebar:
    st.write("Top 10 question recommendations:")
    if st.button("click"):
        questions = top_5_ques()
        st.write(questions)
